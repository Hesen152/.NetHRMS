using dotnethrmsmy.Application;
using dotnethrmsmy.Application.Common.Interfaces;
using dotnethrmsmy.Domain.Entities;
using dotnethrmsmy.Infrastructure;
using dotnethrmsmy.Infrastructure.Persistence;
using dotnethrmsmy.WebUI.Filters;
using dotnethrmsmy.WebUI.Services;
...
namespace dotnethrmsmy.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configure.Title = "dotnethrmsmy API";
